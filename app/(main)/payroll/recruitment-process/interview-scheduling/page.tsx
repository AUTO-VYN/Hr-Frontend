...
export default function InterviewSchedulingPage() {
  ...
  useEffect(() => {
    ...
    if (formData1?.INTR1STATUS) {
      if (formData1?.INTR2BY && formData1?.INTR2DATE && formData1?.INTR2TIME) {
        setShowSave2(true);
        setShowSchedule2(true);
  ...
  useEffect(() => {
    ...
    if (formData1?.INTR2STATUS) {
      if (formData1?.INTR3BY && formData1?.INTR3DATE && formData1?.INTR3TIME) {
        setShowSave3(true);
        setShowSchedule3(true);
  ...
  useEffect(() => {
    ...
    if (formData1?.INTR3STATUS) {
      if (formData1?.INTR4BY && formData1?.INTR4DATE && formData1?.INTR4TIME) {
        setShowSave4(true);
        setShowSchedule4(true);
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0A0F1C] text-[#1E293B] dark:text-[#E7ECF3] p-4 sm:p-6 lg:p-7 space-y-4 max-w-[1780px] mx-auto pb-28 font-sans">
      {/* ────────────────────────────────────────────────────────────────────────── */}
      ...
      <div className="rounded-[12px] border border-[#E2E8F0] dark:border-[#1F2937] bg-white dark:bg-[#111827] shadow-[0_1px_2px_rgba(15,23,42,.04),0_10px_26px_-14px_rgba(15,23,42,.14)] overflow-hidden">
        ...
        <div className="p-4 sm:p-[18px_20px] flex items-center justify-between gap-3.5 border-b border-[#E2E8F0] dark:border-[#1F2937]">
          <div className="flex items-center gap-3.5 min-w-0">
            <span className="w-[50px] h-[50px] rounded-full flex items-center justify-center text-[15px] font-[650] bg-[#EEF2FF] text-[#4F46E5] dark:bg-[#1E1B4B] dark:text-[#8B84FF] shrink-0">
              {candidateInitials}
            </span>

            <div className="min-w-0">
              <div className="flex items-center gap-2.5 flex-wrap">
                <h1 className="text-[19px] font-[650] tracking-[-0.02em] text-[#1E293B] dark:text-white capitalize truncate">
                  {formData1?.NAME || "Unnamed candidate"}
                </h1>
                <span className="text-[10.5px] font-bold text-[#F59E0B] bg-[rgba(245,158,11,.14)] px-[9px] py-[3px] rounded-full whitespace-nowrap">
                  {formData1?.INT_STATUS === "101"
                    ? "Selected"
                    : formData1?.INT_STATUS === "102"
                    ? "Rejected"
              ...
              <p className="text-[12.5px] text-[#64748B] dark:text-[#94A3B8] font-normal mt-1 truncate">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="h-8 px-3 rounded-[10px] text-[12.5px] font-[550] border border-[#E2E8F0] dark:border-[#1F2937] bg-white dark:bg-[#111827] text-[#1E293B] dark:text-[#E7ECF3] hover:bg-[#F1F5F9] dark:hover:bg-[#182235] transition cursor-pointer flex items-center gap-1.5 whitespace-nowrap"
            >
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="w-8 h-8 rounded-[9px] border border-[#E2E8F0] dark:border-[#1F2937] bg-transparent text-[#64748B] dark:text-[#94A3B8] hover:bg-[#F1F5F9] dark:hover:bg-[#182235] flex items-center justify-center cursor-pointer disabled:opacity-30"
              >
                <ChevronLeft className="h-4 w-4" />
              </button>
              <span className="px-1.5 text-[12px] text-[#64748B] dark:text-[#94A3B8] font-medium tabular-nums">
                1 / 3
              </span>
              <button
                type="button"
                ...
                className="w-8 h-8 rounded-[9px] border border-[#E2E8F0] dark:border-[#1F2937] bg-transparent text-[#64748B] dark:text-[#94A3B8] hover:bg-[#F1F5F9] dark:hover:bg-[#182235] flex items-center justify-center cursor-pointer"
              >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 border-b border-[#E2E8F0] dark:border-[#1F2937]">
          {[
            ...
            <div
              key={idx}
              className="p-[12px_16px] border-r border-[#E2E8F0] dark:border-[#1F2937] last:border-r-0 min-w-0"
            >
              <div className="text-[10.5px] font-[600] text-[#64748B] dark:text-[#94A3B8] tracking-[.03em] uppercase">
                {s.label}
              </div>
              <div className="text-[13.5px] font-[600] mt-1 tabular-nums truncate text-[#1E293B] dark:text-[#E7ECF3]">
                {s.value}
              </div>
            </div>
          ))}
        ...
        <div className="p-[12px_20px_14px_20px]">
          <button
            ...
            className="inline-flex items-center gap-1.5 text-[12.5px] font-[600] text-[#4F46E5] hover:underline dark:text-[#8B84FF] cursor-pointer transition"
          >
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="flex items-center gap-[9px] text-[11.5px] text-[#64748B] dark:text-[#94A3B8]">
              ...
              >
                ...
                <div className="flex gap-[7px]">
                  <button
                    ...
                    className="flex-1 h-[36px] rounded-[9px] text-[12px] font-[600] flex items-center justify-center gap-[5px] transition cursor-pointer whitespace-nowrap bg-[#4F46E5] hover:brightness-110 text-white disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 h-[36px] rounded-[9px] text-[12px] font-[600] flex items-center justify-center gap-[5px] transition cursor-pointer whitespace-nowrap border border-[#4F46E5] text-[#4F46E5] hover:bg-[#EEF2FF] dark:hover:bg-[#1E1B4B] disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                  ...
                  <button
                    ...
                    title="Reset round"
                    className="w-[32px] h-[36px] flex items-center justify-center rounded-[9px] border border-[#E2E8F0] dark:border-[#1F2937] bg-transparent text-[#64748B] hover:text-[#E11D48] hover:bg-[rgba(225,29,72,.1)] transition cursor-pointer shrink-0 disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                ...
                <div className="pt-[11px] border-t border-[#E2E8F0] dark:border-[#1F2937] flex flex-col gap-[8px]">
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          disabled
                          className={`py-[6px] px-[6px] text-[11px] font-[600] rounded-[8px] transition whitespace-nowrap text-center select-none cursor-default ${
                  ...
                  <button
                    ...
                    className="w-full h-[34px] flex items-center justify-center gap-[6px] border border-[#E2E8F0] dark:border-[#1F2937] bg-transparent text-[#4F46E5] hover:bg-[#EEF2FF] dark:hover:bg-[#1E1B4B] text-[12px] font-[600] rounded-[9px] cursor-pointer transition"
                  >
      ...
      <div
        ...
        className="fixed bottom-0 right-0 z-40 bg-white/95 dark:bg-[#111827]/95 backdrop-blur-md border-t border-[#E2E8F0] dark:border-[#1F2937] p-[12px_24px] shadow-lg transition-[left] duration-150 ease-in-out max-sm:!left-0"
      >
        <div className="max-w-[1780px] mx-auto flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <input
              ...
              className="w-full md:w-[380px] lg:w-[460px] h-[38px] px-[11px] text-[12.5px] font-medium rounded-[10px] border border-[#E2E8F0] dark:border-[#1F2937] bg-white dark:bg-[#0E1524] text-[#1E293B] dark:text-[#E7ECF3] placeholder:text-[#64748B] outline-none focus:border-[#4F46E5] shadow-2xs disabled:opacity-50"
            />
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5 justify-end w-full md:w-auto">
            ...
            <button
              ...
              className="h-[38px] px-[14px] rounded-[10px] text-[12.5px] font-[600] border border-[rgba(225,29,72,.4)] text-[#E11D48] hover:bg-[rgba(225,29,72,.09)] transition flex items-center gap-[7px] cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
            >
              <X className="h-4 w-4" />
              <span>Reject</span>
            </button>
            ...
            <button
              ...
              className="h-[38px] px-[14px] rounded-[10px] text-[12.5px] font-[600] bg-[#10B981] hover:brightness-110 text-white transition flex items-center gap-[7px] cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed shadow-sm"
            >
              <Check className="h-4 w-4" />
              <span>Select</span>
            </button>

            <span className="w-[1px] h-[26px] bg-[#E2E8F0] dark:bg-[#1F2937] hidden sm:block" />
            ...
            {formData1?.INT_STATUS != "103" && (
              <button
                ...
                className="h-[38px] px-[14px] rounded-[10px] text-[12.5px] font-[550] border border-[#E2E8F0] dark:border-[#1F2937] bg-white dark:bg-[#111827] text-[#1E293B] dark:text-[#E7ECF3] hover:bg-[#F1F5F9] dark:hover:bg-[#182235] transition flex items-center gap-[7px] cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
              >
            ...
            {formData1?.INT_STATUS != "103" && (
              <button
                ...
                disabled={formData1?.INT_STATUS == "101" ? false : true}
                className="h-[38px] px-[16px] rounded-[10px] text-[12.5px] font-[600] bg-[#4F46E5] hover:brightness-110 text-white transition flex items-center gap-[7px] cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed shadow-sm"
              >
            ...
            {formData1?.INT_STATUS == "103" && (
              <AButton
                ...
                className="!h-10 !px-4 !rounded-xl !text-sm !font-semibold !border-rose-200 !text-rose-600 hover:!bg-rose-50 cursor-pointer"
              >
        ...
        <DialogContent className="w-full max-w-2xl bg-white dark:bg-[#0B1220] p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-3">
            <button
              ...
              className="h-10 px-5 rounded-xl border border-slate-200 dark:border-slate-800 text-sm font-semibold text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800"
            >
              Cancel
            </button>
            ...
            <button
              ...
              className="h-10 px-6 rounded-xl bg-[#193A69] hover:bg-[#153157] text-white text-sm font-semibold inline-flex items-center gap-2 shadow-sm disabled:opacity-70 cursor-pointer"
            >
              {isCreatingEmployee ? (
                <>
