...
const getSectionProgress = (key: string) => {
  ...
  return (
  <div className="w-full  min-h-screen bg-[#F6F7FB] dark:bg-black">
    {/* ===== ONE MAIN HEADER (Back + Breadcrumb + Actions) ===== */}
    <header className=" top-0 -mt-3 mb-2 w-full z-0  dark:bg-black border-b border-[#E6E8EF] dark:border-[#2A2F3A]">
      <div className="px-4 md:px-6 w-full h-16  flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <Button variant="outline" size="default" shape="pill" onClick={handleBack} className="h-10 rounded-xl">
        ...
        <div className="flex flex-wrap items-center justify-end gap-2">
          ...
          {user?.role1.includes("1.1.2") && !SaveDisable && (
            <Button
              variant="primary"
              size="sm" shape="pill" className="px-4"
              onClick={handleSave}
              className="h-10 rounded-xl gap-2"
            >
      ...
      <div className="py-3">
        <div className="grid grid-cols-12 gap-3">
          ...
          <aside className="col-span-12 xl:col-span-3">
            <div className=" dark:bg-black  dark:border-[#2A2F3A] rounded-2xl  p-4">
                ...
                {SECTIONS.map((sec, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-4 rounded-xl  px-2 py-1 text-left transition
                        ${
                          active
                            ? "border-[#2F54EB] bg-[#EEF2FF] dark:bg-[#111827]  dark:border-[#1D4ED8]"
                            : "border-transparent dark:bg-black hover:bg-[#F9FAFB] dark:hover:bg-[#0B1220]"
                        }`}
                    >
                      <div
                        className={`h-10 w-10 rounded-full flex items-center justify-center text-sm font-semibold border
                          ${
                            active
                              ? "border-[#2F54EB]  text-[#2F54EB] bg-white  dark:bg-black"
                              : "border-[#D0D5DD] dark:border-[#2A2F3A] text-[#667085] dark:text-[#A0A7B4]"
                          }`}
                      >
                        {idx + 1}
                      </div>
          ...
          <main className="col-span-12 xl:col-span-9">
            <div className=" dark:bg-black  rounded-2xl  p-3 md:p-4">
