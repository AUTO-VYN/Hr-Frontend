...
const EmpTabs = ({
  ...
  // ✅ Separate scroll for both (thin + light) using Tailwind scrollbar utilities
  // (works if you have `tailwind-scrollbar` plugin enabled)
  const basicJoiningScroll =
    "h-[calc(100vh-220px)] overflow-y-auto overflow-x-hidden pr-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-50 hover:scrollbar-thumb-slate-400 dark:scrollbar-thumb-slate-600 dark:scrollbar-track-slate-900";
  ...
  return (
    <div className="">
      <div className="w-full">
        ...
        {/* CONTENT */}
        <div className="">
          {/* ✅ Basic Joining Detail (Tab 1) => its own scroll */}
          {activeTab === 1 && (
            <div className={basicJoiningScroll}>
              <Page1
