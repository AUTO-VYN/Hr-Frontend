...
function Card({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
      <div className="flex items-center justify-between gap-2 sm:gap-3 border-b border-slate-200 px-4 sm:px-6 py-3 sm:py-4 dark:border-slate-800">
        <div className="flex items-center gap-2 sm:gap-3">
          {icon ? (
            <span className="text-violet-600 dark:text-violet-400">{icon}</span>
          ) : null}
          <h2 className="text-xs sm:text-sm font-semibold tracking-wider text-slate-900 uppercase dark:text-slate-100">
            {title}
          </h2>
        </div>
        {right}
      </div>
      <div className="p-3.5 sm:p-5 text-slate-900 dark:text-slate-100">
        {children}
      </div>
    </div>
  );
    ...
    <>
      ...
      >
        ...
        <div
          ...
          className="min-h-0 overflow-y-auto pr-1 sm:pr-2 pb-24"
        >
            ...
            <div className="space-y-4 sm:space-y-6">
              <Card
                ...
                right={
                  <button
                    ...
                    className={`inline-flex items-center gap-1.5 sm:gap-2 rounded-xl border px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium transition
                      ${
                        isAllSelected
              ...
              >
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="h-[285px] overflow-y-auto rounded-xl border border-slate-200 bg-white p-3 sm:p-4 dark:border-slate-800 dark:bg-slate-900">
                    {filteredLocations.length > 0 ? (
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 sm:gap-x-10 gap-y-1">
                        {[
                          ...
                          <div key={colIdx} className="space-y-2 sm:space-y-3">
                            {col.map((location: any) => {
                              ...
                              return (
                                <button
                                  ...
                                  disabled={!selectable}
                                  className={`flex w-full items-center gap-2.5 sm:gap-3 rounded-lg px-2 py-1.5 text-left transition
                                    ${
                                      !selectable
                                ...
                                >
                                  ...
                                  <span
                                    className="truncate text-xs sm:text-sm text-slate-800 dark:text-slate-200"
              ...
              <Card
                ...
                right={
                  <button
                    ...
                    className="inline-flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800"
