          ...
          <div className="grid grid-cols-12 fluid-gap-sm p-4 max-w-full">
            <div className="col-span-12 md:col-span-6 min-w-0">
              <Einput
                ...
                title="Father's Name"
                name="FATHERNAME"
                value={formData.EmpMst.FATHERNAME || formData?.EmpMst?.fatherNameAadhaar}
            ...
            <div className="col-span-12 md:col-span-6 min-w-0">
              <Einput
                ...
                name="DOM"
                value={formData.EmpMst.DOM ? formData.EmpMst.DOM.slice(0, 10) : ""}
                handleInputChange={handleInputChange}
          ...
          <div className="grid grid-cols-12 fluid-gap-sm p-4 max-w-full">
            ...
            <div className="col-span-12 md:col-span-6 min-w-0">
              <SelectSearch
                ...
                name="PCITY"
                className="!h-[30px]"
                selectedValue={formData.EmpMst.PCITY ? formData.EmpMst.PCITY.toString() : null}
                handleInputChange={handleInputChange}
            ...
            <div className="col-span-12 md:col-span-6 min-w-0">
              <Eselect
                ...
                title="State"
                name="PSTATE"
                initialValue={formData.EmpMst.PSTATE ? formData.EmpMst.PSTATE.toString() : null}
                handleInputChange={handleInputChange}
            ...
            <div className="col-span-12 md:col-span-6 min-w-0">
              <Eselect
                ...
                title="District"
                name="PDIST"
                initialValue={formData.EmpMst.PDIST ? formData.EmpMst.PDIST.toString() : null}
                handleInputChange={handleInputChange}
            ...
            <div className="col-span-12 min-w-0 ">
              <div className="rounded-lg border border-[var(--border)] bg-[var(--sub)] px-2 py-2">
                <Acheckbox
                   ...
                   value={isChecked} disabled={undefined} ShortName={undefined}                />
              </div>
            </div>
            ...
            <div className="col-span-12 md:col-span-6 min-w-0">
              <SelectSearch
                ...
                name="CCITY"
                className="!h-[30px]"
                selectedValue={formData.EmpMst.CCITY ? formData.EmpMst.CCITY.toString() : null}
                handleInputChange={handleInputChange}
              />
            </div>
            ...
            <div className="col-span-12 md:col-span-6 min-w-0">
              <Eselect
                title="Current State"
                name="CSTATE"
                initialValue={formData.EmpMst.CSTATE ? formData.EmpMst.CSTATE.toString() : null}
                option={Stateoption}
                handleInputChange={handleInputChange}
              />
            </div>
            ...
            <div className="col-span-12 md:col-span-6 min-w-0">
              <Eselect
                ...
                name="CDIST"
                initialValue={formData.EmpMst.CDIST ? formData.EmpMst.CDIST.toString() : null}
                option={DistrictOption}
                handleInputChange={handleInputChange}
              />
            </div>
